...
from gen_vhost.infrastructure.cli.setup.opt_validator import CLIBundleOptionsValidator
from gen_vhost.infrastructure.cli.setup.bundle import CLIBundle
from gen_vhost.infrastructure.cli.setup.keys import CLIBundleKeys
...
class CLIBundleFactory:
    ...
    def create_bundle(cls, options: CLIBundleOptions) -> CLIBundle:
        ...
        service_definition: ICommandDefinition = GenVhostCommandDefinition()
        service_executor: ICommandExecutor = GenVhostCommandExecutor(definition=service_definition)
