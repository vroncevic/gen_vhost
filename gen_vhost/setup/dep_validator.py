...
Info
    Validator for the gen_vhost bundle dependencies.
'''
...
class GenVhostBundleDependenciesValidator:
    '''
        Validator for the gen_vhost bundle dependencies.
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the gen_vhost bundle dependencies.
                | is_valid - Checks if the gen_vhost bundle dependencies is valid.
    '''

    @classmethod
    def validate(cls, dependencies: GenVhostBundleDependencies) -> None:
        '''
            Validates the gen_vhost bundle dependencies.

            :param dependencies: The gen_vhost bundle dependencies to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_vhost_bundle_dependencies_validator::validate(...)'
        msg_dependencies_none: str = 'the gen_vhost bundle dependencies must be provided'
        msg_dependencies_istype: str = 'the gen_vhost bundle dependencies must be a Mapping'

        not_none(dependencies, ctx, msg_dependencies_none)
        istype(dependencies, Mapping, ctx, msg_dependencies_istype)

        for attr_name, expected_type in GenVhostBundleKeys.get_dependency_to_type().items():
    ...
    @classmethod
    def is_valid(cls, genvhostbundledependencies: GenVhostBundleDependencies) -> bool:
        '''
            Checks if the genvhostbundledependencies is valid.

            :param genvhostbundledependencies: The genvhostbundledependencies to be checked.
            :return: True if valid, False otherwise.
        '''
        try:
            cls.validate(genvhostbundledependencies)
            return True
